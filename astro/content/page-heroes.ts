...
export const pageHeroes = {
	...
	home: {
		...
		descriptionClass:
			'mx-auto mb-5 max-w-6xl text-center font-manrope text-lg leading-relaxed !text-white opacity-70 [text-shadow:0_2px_18px_rgba(0,0,0,0.72)] md:mb-6 md:text-lg lg:mb-7 lg:text-xl lg:whitespace-nowrap',
