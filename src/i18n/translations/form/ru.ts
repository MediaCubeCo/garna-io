export const formRu = {
	...
	images: {},
	form: {
		heading: 'Запишитесь на бесплатное 30-минутное демо продукта',
	...
	bookingWidget: {
		title: 'Запишитесь на бесплатное 30-минутное демо продукта',
		subtitle: 'Получите ответы на все вопросы от наших экспертов',
		campaigns: {
			linkedinInmail: {
				heading: 'Бесплатное демо по международным выплатам',
				subtitle:
					'Банковские счета, карты, crypto, e-wallets в 180+ странах, включая СНГ. Получите ответы на все вопросы от нашей команды за 30 минут.',
				promoBannerText: 'После демо вы получите гайд по открытию счетов в европейских и американских банках.',
			},
		},
