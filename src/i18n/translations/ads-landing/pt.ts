export const eorPt = {
	...
	"hero": {
		...
		"notifications": {
			...
			"dueInSevenDays": "2400 € · Vence em 7 dias",
			"available": "3850 $ · Disponível",
			"usdInvoice": "Fatura em USD",
			"eurInvoice": "Fatura em EUR"
		},
		"cta": "Criar conta",
		"slides": {
			"hire": {
	...
	"stats": {
		"clients": "faturação para clientes globais",
		"companySetup": "empresas a abrir",
		"workflow": "lugar para faturas e pagamentos"
	},
	"transparentPricing": {
	...
	"audience": {
		"title": "Para quem é a faturação global",
		"description": "Uma forma simples de faturar clientes internacionais, onde e como quer que trabalhe",
		"cards": {
			"freelancers": {
				"title": "Freelancers",
				"description": "Trabalha diretamente com clientes empresariais de diferentes países"
			},
			"contractors": {
				"title": "Prestadores remotos",
				"description": "Trabalha para uma empresa global como profissional independente"
			},
			"nomads": {
				"title": "Nómadas digitais",
				"description": "Move-se entre países enquanto trabalha com clientes em todo o mundo"
			},
			"teams": {
				"title": "Startups e agências",
				"description": "Entrega projetos em equipa e precisa de um processo de pagamento claro"
			}
		}
	},
	"professional": {
		"title": "Apresente-se aos clientes com profissionalismo",
		"description": "Envie faturas profissionais com uma forma clara de pagamento, sem abrir a sua empresa",
		"followUp": "A Garna reúne faturas, dados de pagamento e documentos desde o início",
		"button": "Criar conta",
		"visual": {
			"invoice": "Fatura",
	...
	"globalInvoicingHowTo": {
		...
		"panel": {
			...
			"invoice": {
				...
				"clientLabel": "Cliente",
				"itemsLabel": "Itens da fatura",
				"designItem": "Design · $1,600",
				"consultingItem": "Consultoria · $800",
				"detailsLabel": "Detalhes da fatura",
				"detailsValue": "#0148 · Vence a 30 de maio",
				"totalLabel": "Total a pagar",
				"sendButton": "Enviar fatura",
				"invoiceLabel": "Fatura",
				"billToLabel": "Faturar a",
				"issuedLabel": "Emitida",
				"issuedValue": "15 de maio de 2026",
				"dueLabel": "Vence",
				"dueValue": "30 de maio de 2026",
				"serviceLabel": "Serviço",
				"amountLabel": "Valor",
				"designService": "Design de marca",
			...
			"withdraw": {
				...
				"cardTitle": "Transferência para cartão",
				"walletTitle": "Carteiras eletrónicas",
				"cryptoTitle": "Criptomoedas"
			}
		},
		"steps": {
			"step1": { "title": "Crie a sua conta Garna", "description": "Configure o seu perfil e conclua a verificação para começar a faturar empresas" },
			"step2": { "title": "Crie e envie uma fatura", "description": "Adicione o cliente e emita uma fatura empresarial clara numa moeda suportada" },
			"step3": { "title": "O cliente paga a fatura", "description": "O cliente segue as instruções da fatura e envia o pagamento através da Garna" },
			"step4": { "title": "Levante os seus fundos", "description": "Quando o pagamento chegar ao saldo Garna, levante-o através de um método disponível" }
		}
	},
	"twoWays": {
		"title": "Duas formas de receber pagamentos",
		"description": "Escolha o fluxo de pagamento certo para cada cliente e projeto",
		"tabs": {
			"ariaLabel": "Formas de receber pagamentos com a Garna",
			"invoice": "Fatura",
	...
	"sectionTags": {
		...
		"oneHiringSystem": "Um sistema de contratação",
		"whyGarna": "Porquê a Garna",
		"fitCheck": "Verificação de adequação",
		"howItWorks": "Como funciona"
	},
	"visual": {
		"cards": {
		...
		"why": {
			"talentSearch": "Pesquisa de talento",
			"globalMatching": "Matching global",
			"global": "Global",
			"match92": "92% de compatibilidade",
			"match88": "88% de compatibilidade",
	...
	"whatElseYouGet": {
		"title": "O que mais recebe",
		"description": "Ferramentas práticas e apoio para gerir pagamentos de clientes internacionais para além da própria fatura",
		"button": "Criar conta",
		"benefits": {
			"withdrawals": {
	...
	"comparisonTable": {
		...
		"columns": {
			...
			"otherCard": "Cartões de amigos",
			"crypto": "Criptomoedas"
		},
		"rows": {
			"noCompany": "Sem necessidade de abrir uma empresa",
			"clientPayments": "Pagamentos simples para clientes",
			"documents": "Contrato e fatura oficiais",
			"guarantee": "Garantia de pagamento",
			"withdrawals": "Levantamentos fáceis à sua maneira",
			"accountBlocks": "Sem bloqueios repentinos da conta",
			"fees": "Comissão transparente"
		},
		"status": {
			"yes": "Sim",
			"no": "Não",
	...
	"why": {
		...
		"tabs": {
			"sourcing": {
				"label": "Recrutamento",
				"title": "Encontrar rapidamente os talentos certos",
				"problem": "A contratação internacional torna-se mais lenta porque muitas empresas não possuem as ferramentas necessárias para contratar pessoas em todos os países onde precisam operar",
			...
			"timeOff": {
				...
				"title": "Centralizar políticas de férias e despesas num único lugar",
				"solution": "As regras de férias, políticas de reembolso e outros requisitos variam de país para país, tornando difícil para equipas de RH e financeiras gerir tudo corretamente. A Garna permite gerir férias e despesas das suas equipas internacionais através de um único sistema simples de utilizar"
			},
			"reporting": {
				"label": "Relatórios",
	...
	"costEstimator": {
		...
		"form": {
			...
			"client": "Cliente",
			"paymentMethod": "Como o cliente paga",
	...
	"faq": {
		"title": "Perguntas frequentes sobre faturação global",
		"items": {
			"q1": {
				"question": "Como recebo de um cliente estrangeiro?",
				"answer": "Registe-se na Garna, crie uma fatura numa moeda suportada e envie-a ao seu cliente empresarial. O cliente fornece os dados necessários da empresa e paga pelo método disponível. Quando o pagamento é recebido e verificado, os fundos aparecem no seu saldo Garna para levantamento."
			},
			"q2": {
				"question": "Preciso de abrir uma empresa?",
				"answer": "Não. A Garna fornece o processo de faturação e pagamento necessário para trabalhar com clientes empresariais sem abrir a sua própria empresa. A disponibilidade e a estrutura exata podem depender do seu país e da rota de pagamento do cliente."
			},
			"q3": {
				"question": "Para onde posso levantar o dinheiro?",
				"answer": "Os métodos disponíveis podem incluir contas bancárias, cartões, carteiras eletrónicas e criptomoedas. As opções exatas dependem do seu país e da sua conta e são apresentadas no painel Garna. Quando suportado, pode dividir os fundos entre diferentes destinos."
			},
			"q4": {
				"question": "Em que moeda vou receber?",
				"answer": "O cliente paga a fatura numa moeda suportada, como dólares americanos ou euros. As moedas de levantamento disponíveis dependem do seu país e do método escolhido e são apresentadas antes da confirmação da transação."
			},
			"q5": {
				"question": "Posso levantar fundos em criptomoeda?",
				"answer": "Os levantamentos em criptomoeda podem estar disponíveis para contas e jurisdições suportadas. Consulte o painel Garna para ver moedas, redes, limites e requisitos disponíveis."
			},
			"q6": {
				"question": "Quanto tempo demora a receber o dinheiro?",
				"answer": "O prazo depende do método de pagamento do cliente, da rota bancária e de qualquer verificação necessária. Muitos pagamentos chegam rapidamente, enquanto verificações adicionais ou bancos intermediários podem prolongar o processamento. Pode acompanhar o estado na sua conta Garna."
			},
			"q7": {
				"question": "Como sei que o cliente vai pagar?",
				"answer": "Uma fatura regista o valor e as condições, mas não obriga o cliente a pagar. Antes de começar, acorde condições claras e utilize qualquer opção de proteção disponível para a sua conta. A Garna mostra o estado assim que os fundos entram no processo de pagamento."
			},
			"q8": {
				"question": "Que taxas cobra a Garna?",
				"answer": "As taxas dependem do método de pagamento do cliente, da rota da moeda e da opção de levantamento. A Garna apresenta a taxa, a comissão e o total aplicáveis antes de confirmar a transação."
			},
			"q9": {
				"question": "Que documentos vou receber?",
				"answer": "A sua conta Garna mantém a fatura e os registos de pagamento disponíveis num só lugar. O conjunto exato depende do processo de pagamento e do seu país e pode ser consultado ou descarregado a partir da transação correspondente."
			}
		}
	},
	"finalCta": {
		"title": "Receba o seu primeiro pagamento com a faturação global",
		"description": "Crie a sua conta Garna gratuitamente e pague apenas quando receber o pagamento de um cliente",
		"button": "Criar conta"
	},
	"dashboardCta": {
