export const homePt = {
	...
	sectionDescriptions: {
		...
		manageGlobalPayroll: 'Uma plataforma para operar payroll de freelancers, colaboradores remotos e equipas a tempo inteiro',
		hireEmployeesWorldwide: 'Encontre e contrate talentos que não encontrava localmente sem criar uma entidade legal local',
		effectivePayroll: 'Pagamentos em massa por CSV ou transferências individuais, sem atrasos e sem taxas extras. Automatize depois de configurar',
		deferredPayments:
	...
	manageGlobalPayroll: {
		cards: {
			automation: {
				title: 'Plataforma de payroll automatizada',
				description: 'Automatize processos globais de pagamento com uma plataforma flexível e fácil de usar',
			},
			globalReach: {
				title: 'Alcance global',
				description: 'Pague em mais de 150 países com moedas locais e cripto',
			},
			payoutMethods: {
				title: 'Métodos de pagamento flexíveis',
				description: 'Pague a equipas por transferência bancária, cartão, carteira eletrónica ou cripto',
			},
			fees: {
				title: 'Sem taxas ocultas',
				description: 'Preços transparentes, custo zero de configuração',
			},
		},
		visual: {
			automation: {
	...
	contractorCarousel: {
		features: {
			hire: {
				title: 'Contrate contratados\nem todo o mundo',
				description: 'Faça a gestão de contratados, faturas e aprovações a partir de uma única plataforma',
			},
			payments: {
				title: 'Pagamentos globais\nflexíveis',
				description: 'Pague em mais de 80 moedas e 150 países por banco, cartão, e-wallet ou cripto',
			},
			protection: {
				title: 'Tenha proteção\ncontra classificação incorreta',
				description: 'A Garna atua como contractor ou agent of record e assume riscos de classificação incorreta',
			},
		},
		notifications: {
			hire: {
				name: 'Maya Chen',
				status: 'Contratado integrado',
				badge: 'Ativo',
			},
			payment: {
				time: 'Há 2 min',
				title: 'Pagamento enviado',
				description: '1.000 USD foram convertidos em 900 EUR',
			},
			compliance: {
				riskLabel: 'Risco de classificação',
				riskValue: 'Baixo',
				reviewLabel: 'Revisão do contrato',
				reviewValue: 'Concluída',
				footerTitle: 'Protegido pela Garna',
				footerMeta: 'atualizado agora',
			},
		},
	},
	spendbaseQuote: {
