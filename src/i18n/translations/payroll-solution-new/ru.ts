...
export const payrollSolutionNewRu = {
	meta: {
		title: 'Глобальная система оплаты труда и платежей в более чем 150 странах | Garna',
		description:
			'Надежное программное обеспечение для оплаты труда, предназначенное для международных компаний. Автоматизируйте оплату труда, уплату налогов и обеспечение соблюдения нормативных требований на международном уровне. Осуществляйте быстрые выплаты своим сотрудникам в любой валюте или криптовалюте.',
	},
	images: {},
	legacy: {
		visual: {
	...
	legacyText: {
		...
		'Hire employees anywhere in the world without setting up local legal entities':
			'нанимайте сотрудников в любой точке мира без необходимости создания местных юридических лиц. Garna выступает в качестве официального работодателя, занимаясь вопросами налогообложения, выплаты льгот и обеспечения полного соблюдения трудового законодательства',
		...
		'We help you not only find talent, but also apply for a visa and permanent residence support':
			'Мы помогаем вам не только найти талантливых специалистов, но и оформить визу и получить поддержку в вопросах получения постоянного вида на жительство, чтобы ваши сотрудники могли работать из любой точки мира без лишних юридических сложностей',
		...
		'Garna integrates seamlessly with your existing HR processes and accounting payroll software':
			'вам не нужно кардинально менять свои процессы, чтобы адаптироваться к нам. Garna легко интегрируется с вашими существующими кадровыми процессами и программами оплаты труда',
		...
		'Integrate global contractor payments directly into your platform':
			'Интегрируйте платежи международным подрядчикам прямо в вашу платформу. Предоставьте пользователям возможность выводить средства и получать платежи на вашей платформе одним щелчком мыши — без необходимости переходить на сторонние сайты',
		...
		'SSpecify the person who will be responsible for financial matters':
			'Укажите лицо, которое будет отвечать за финансовые вопросы. Это может быть финансовый директор, руководитель финансового отдела или вы сами',
		...
		"Enter the employee's details":
			'Введите данные о сотруднике: страну работы, должность, заработную плату, дату начала работы, валюту выплаты заработной платы и требования к рабочей визе',
		...
		'Everything is relative, right? Take a look at the comparison table, we believe our transparency speaks louder than words. We offer, and we offer a lot, because we want to be the best':
			'Всё относительно, верно? Взгляните на сравнительную таблицу — мы уверены, что факты говорят громче слов. Мы предоставляем множество услуг, потому что стремимся быть лучшими',
		'Feature': 'Функция',
		...
		'Find out why large companies and middle-sized businesses are switching to Garna. We set the standard for international payroll, trusted by professionals in over 150 countries':
			'Узнайте, почему крупные и средние компании переходят на Garna. Мы устанавливаем стандарты в сфере оплаты труда на международном уровне, и нам доверяют специалисты в более чем 150 странах',
		...
		'We assume full responsibility for compliance with the labor code of each country, from taxes to social benefits. Our team is monitoring any legal changes':
			'Мы берем на себя полную ответственность за соблюдение трудового законодательства каждой страны, от уплаты налогов до выплаты социальных льгот. Наша команда отслеживает все изменения в законодательстве',
		'Make payments in one click in any currency. The system calculates taxes and other contributions immediately':
			'Производите платежи в один клик в любой валюте. Система мгновенно рассчитывает налоги и другие отчисления',
